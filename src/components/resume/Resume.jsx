            ...
            <div className=" relative">
              ...
              <div className=" flex flex-col gap-1 sm:gap-1 border-2 border-yellow-400 shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-3 rounded-lg">
                ...
                <p className=" text-[.9rem] text-justify break-words text-gray-500">
                  Developed responsive e-commerce websites using HTML, CSS,
                  JavaScript, jQuery, and Bootstrap, ensuring seamless user
                  experiences.
                  <br />
                  Collaborated as a full-time intern at ZenCommerce India,
                  actively learning and problem-solving to enhance development
                  skills.
                  <br />
                  Developed responsive e-commerce websites using HTML, CSS,
                  JavaScript, jQuery, and Bootstrap, ensuring seamless user
                  experiences.
                  <br />
                  Skills: Web Projects · User Interface Design · Bootstrap
                  (Framework) · HTML5 · css3 · WordPress · jQuery · JavaScript
                </p>
              </div>
            </div>
          </fieldset>
