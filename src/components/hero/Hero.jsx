...
const Hero = () => {
  return (
    <div id="home" className={` bg-gradient-to-r from-green-200 to-blue-200 `}>
      <div className=" container mx-auto pt-5 h-[100vh] md:h-[100vh] md:flex-col-reverse sm:h-[100vh]  flex sm:flex-col-reverse sm:pt-0 ">
        <div className=" left mt-4 md:mt-0 flex-1 flex flex-col justify-center gap-5 w-1/2 md:w-full md:py-2 sm:py-0">
          <div className="info w-fit flex flex-col items-start justify-center gap-3 sm:gap-2">
            ...
            <TypeAnimation
              data-aos="fade-up"
              sequence={["Full-Stack Developer", 2000, "Freelancer", 2000, ""]}
              speed={30}
              wrapper="h3"
              repeat={Infinity}
          ...
          <div className="icons flex mt-5">
            ...
            >
              <li>
                <a href="https://github.com/SwapnilMk" target="_blank">
                  {" "}
                  <AiFillGithub className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125" />{" "}
                </a>
              </li>
              <li>
                <a href="https://leetcode.com/SwapnilMk/" target="_blank">
                  {" "}
              ...
              <li>
                <a href="https://twitter.com/Swapy_mk" target="_blank">
                  {" "}
                  <AiFillTwitterCircle className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125  " />{" "}
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/swapyy_mk/" target="_blank">
                  {" "}
                  <AiFillInstagram className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125  " />{" "}
                </a>
              </li>
              <li>
                <a href="https://www.facebook.com/swapmahadik/" target="_blank">
                  {" "}
