...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className='w-full bg-white font-sans dark:bg-transparent'
      ref={containerRef}
    >
      <div className='mx-auto px-4 pt-24 md:px-8 lg:px-10'>
        <h2 className='mb-4 max-w-4xl text-lg font-bold text-black dark:text-white md:text-4xl'>
          Journey: Experience & Education
        </h2>
        <p className='max-w-full text-sm text-neutral-700 dark:text-neutral-300 md:text-base'>
          I&apos;ve been working as Software Developer for the past 2 years, and
          growing through education and professional experience. Here&apos;s a
